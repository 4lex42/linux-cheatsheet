...
class TestFraction(TestCase):
    def test___init__(self):
        ...
        self.assertEqual(frac4.numerator_simplifiee, 2,
                         "__init__ : test du numérateur normal avec un den et num  négatif")
        self.assertEqual(frac4.denominator_simplifiee, 1,
                         "__init__ : test du denominator normal avec un den et num négatif")
    ...
    def test__add__(self):
        # Test addition with positive fractions
        frac1 = Fraction(10, 5)
        other1 = Fraction(10, 5)
        result = frac1 + other1
        ...
        # Test addition with negative numerator
        frac3 = Fraction(-10, 5)
        other1 = Fraction(10, 5)
        result = frac3 + other1
        ...
        # Test addition with negative denominator
        frac4 = Fraction(10, -5)
        other2 = Fraction(11, 5)
        result = frac4 + other2
        ...
        # Test addition with negative numerator and denominator
        frac2 = Fraction(11, 5)
        other5 = Fraction(-10, -5)
        result = frac2 + other5
        ...
        # Test addition with zero numerator
        frac6 = Fraction(0, 5)
        other1 = Fraction(10, 5)
        result = frac6 + other1
        ...
        # Test addition with zero numerator and negative numerator
        frac6 = Fraction(0, 5)
        other3 = Fraction(-10, 5)
        result = frac6 + other3
        self.assertEqual(result.numerator, -2)
        ...
        # Test addition with zero numerator and negative denominator
        frac6 = Fraction(0, 5)
        other4 = Fraction(10, -5)
        result = frac6 + other4
        self.assertEqual(result.numerator, -2)
    ...
    def test__sub__(self):
        # Test subtraction with positive fractions
        frac1 = Fraction(10, 5)
        other1 = Fraction(10, 5)
        result = frac1 - other1
        self.assertEqual(result.numerator, 0)
        ...
        # Test subtraction with negative numerator
        frac3 = Fraction(-10, 5)
        other1 = Fraction(10, 5)
        result = frac3 - other1
        self.assertEqual(result.numerator, -4)
        ...
        # Test subtraction with negative denominator
        frac4 = Fraction(10, -5)
        other2 = Fraction(11, 5)
        result = frac4 - other2
        self.assertEqual(result.numerator, -21)
        ...
        # Test subtraction with negative numerator and denominator
        frac2 = Fraction(11, 5)
        other5 = Fraction(-10, -5)
        result = frac2 - other5
        self.assertEqual(result.numerator, 1)
        ...
        # Test subtraction with zero numerator
        frac6 = Fraction(0, 5)
        other1 = Fraction(10, 5)
        result = frac6 - other1
        self.assertEqual(result.numerator, -2)
        ...
        # Test subtraction with zero numerator and negative numerator
        frac6 = Fraction(0, 5)
        other3 = Fraction(-10, 5)
        result = frac6 - other3
        self.assertEqual(result.numerator, 2)
        ...
        # Test subtraction with zero numerator and negative denominator
        frac6 = Fraction(0, 5)
        other4 = Fraction(10, -5)
        result = frac6 - other4
        self.assertEqual(result.numerator, 2)
    ...
    def test__mul__(self):
        # Test multiplication with positive fractions
        frac1 = Fraction(10, 5)
        other1 = Fraction(11, 5)
        result = frac1 * other1
        self.assertEqual(result.numerator, 22)
        self.assertEqual(result.denominator, 5)

        # Test multiplication with negative numerator
        frac3 = Fraction(-10, 5)
        other1 = Fraction(10, 5)
        result = frac3 * other1
        self.assertEqual(result.numerator, -4)
        ...
        # Test multiplication with negative denominator
        frac4 = Fraction(10, -5)
        other2 = Fraction(11, 5)
        result = frac4 * other2
        self.assertEqual(result.numerator, -22)
        ...
        # Test multiplication with negative numerator and denominator
        frac2 = Fraction(11, 5)
        other5 = Fraction(-10, -5)
        result = frac2 * other5
        self.assertEqual(result.numerator, 22)
        ...
        # Test multiplication with zero numerator
        frac6 = Fraction(0, 5)
        other1 = Fraction(11, 5)
        result = frac6 * other1
        self.assertEqual(result.numerator, 0)
        ...
        # Test multiplication with zero numerator and negative numerator
        frac6 = Fraction(0, 5)
        other3 = Fraction(-10, 5)
        result = frac6 * other3
        self.assertEqual(result.numerator, 0)
        ...
        # Test multiplication with zero numerator and negative denominator
        frac6 = Fraction(0, 5)
        other4 = Fraction(10, -5)
        result = frac6 * other4
        self.assertEqual(result.numerator, 0)
    ...
    def test___truediv__(self):
        ...
        self.assertEqual(frac1.__truediv__(other3).__str__(), "-1.0/1.0",
                         "__truediv__ : test pour ne pas avoir un  dénominator negative")
    ...
    def test_is_adjacent_to(self):
        ...
        self.assertEqual(frac5.is_adjacent_to(other5), True,
                         "is_adjacent_to : ou il sont adjacent -1 en négatif et zéro")
        # 8 adjacent  full negatif and positif
        self.assertEqual(frac4.is_adjacent_to(other6), True,
                         "is_adjacent_to : ou il sont adjacent full négatif et posifir")
